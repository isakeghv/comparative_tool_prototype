<template>
    <div class="artifact__media" v-if="artifact" :draggable="false">
        <div v-if="!filePath" class="artifact__image artifact__border"></div>
        <img :src="filePath" :alt="artifact.id" class="artifact__image artifact__border" v-else-if="isImage(artifact.source)"
            draggable="false">
        <svg class="artifact__icon artifact__border" v-else-if="isAudioFile(artifact.source)" viewBox="0 0 88 72" fill="none"
        ...
        <div v-else-if="isPdf(artifact.source)" class="artifact__iframecontainer" draggable="false">
        ...
        <div class="artifact__videocontainer" v-else-if="isVideoFile(artifact.source)">
