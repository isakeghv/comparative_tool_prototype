    ...
    <aside class="aside">
        ...
        <div class="aside__container">
            <div class="aside__selection aside__selection--spaced">
                <input type="checkbox" id="details_duration_checkbox" class="aside__checkbox" :disabled="disabled" value="duration" v-model="closingMethods" @change="updateClosing()">
            ...
            <div class="aside__row">
                ...
                <input type="number" id="details_duration_number" class="aside__input--number font-small" name="details_duration_number" min="0" step="1" :disabled="disabled" v-model="durationModel" @input="durationToMs"/>
                <label for="details_duration_unit" class="hide">Unit: </label>
                <select id="details_duration_unit" name="details_duration_unit" class="aside__select font-small" v-model="selectModel" :disabled="disabled" @change="durationToMs">
        ...
        <div class="aside__container">
            <div class="aside__selection aside__selection--spaced">
                <input type="checkbox" id="details_date_checkbox" class="aside__checkbox" :disabled="disabled" value="date" v-model="closingMethods" @change="updateClosing()">
            ...
            <div class="aside__row">
                ...
                <input type="date" id="details_date" class="aside__input--wide font-small" name="details_date" :disabled="disabled" v-model="dateModel" @change="updateDate()"/>
            </div>
        </div>
        <div class="aside__container">
            <div class="aside__selection aside__selection--spaced">
                <input type="checkbox" id="details_responses_checkbox" class="aside__checkbox" :disabled="disabled" value="responses" v-model="closingMethods" @change="updateClosing()">
            ...
            <div class="aside__row">
                ...
                <input type="number" id="details_responses_number" class="aside__input--number font-small" name="details_responses_number" :disabled="disabled" v-model="responseModel" @input="setResLimit()"/>
        ...
        <div class="aside__container">
            ...
            <input type="number" id="details_desired_qty" class="aside__input--number font-small" name="details_desired_qty" :disabled="disabled" v-model="totalResModel" @input="updateDesiredRes()"/>
        </div>
    </aside>
</template>
