<template>
  <form @submit.prevent="createUser" class="form">
    ...
    <div class="form__cont">
      ...
      <input type="email" name="email" v-model="email" id="login_email_inp" placeholder="Enter email" class="font-normal form__input" required>
    </div>
    ...
    <div class="form__cont">
      ...
      <input type="password" id="login_pwd_inp" name="password" v-model="pwd" placeholder="Enter password" class="font-normal form__input" required>
    </div>
    <div class="form__cont">
