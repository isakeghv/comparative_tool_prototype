<template>
    <form @submit.prevent>
        ...
        <div class="input__cont">
            ...
            <input type="email" id="email" name="email" class="font-normal"><br>
        </div>
        ...
        <div class="input__cont">
            ...
            <input type="password" id="pwd" name="pwd" class="font-normal"><br>
        </div>
        <div class="btn__cont">
            <input type="submit" value="Login" class="font-normal">
