<template>
    <form @submit.prevent="createUser">
        ...
        <div class="input__cont">
            ...
            <input type="password" v-model="pwd" placeholder="Enter password" class="font-normal input__field" required><br>
        </div>
        <div class="btn__cont">
            <input type="submit" value="Login" class="font-normal font-semi">
            <span>Don't have an account? <NuxtLink to="">Sign up</NuxtLink></span>
        </div>
</form>
</template>
