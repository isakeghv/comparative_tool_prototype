<template>
    <form @submit.prevent="registerUser">
        ...
        <div class="input__cont">
            ...
            <input type="name" v-model="name" id="name" placeholder="Enter name" pattern="[A-Za-z\s'\-]+" class="font-small input__field" required><br>
        </div>
        <!-- <div v-if="" id="nameErrMsg" class="error" role="alert"></div> -->
        ...
        <div class="input__cont">
            ...
            <input type="email" v-model="email" id="email" placeholder="Enter email" class="font-small input__field" required><br>
        </div>
        ...
        <div class="input__cont">
            ...
            <input type="password" v-model="pwd" id="pwd" placeholder="Enter password" class="font-small input__field" required><br>
        </div>
        <div class="btn__cont">
...
const emit = defineEmits(['successMsg', 'errMsg'])
