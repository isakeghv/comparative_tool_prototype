<template>
    <div class="link__cont">
        <button class="header__button" :data-tooltip="!isModalOpen ? 'Link' : null" @click="isModalOpen = !isModalOpen" id="header-link-btn">
        ...
        <div class="link__modal" v-if="isModalOpen">
            ...
            <div v-else-if="study.status === 'ongoing' || study.status === 'completed'" class="link__content">
                ...
                <input
                    ...
                    id="copy"
                />
                <a class="font-small link__copy" @click="copyLink" id="copy-link-btn">Copy</a>
            </div>
        </div>
    </div>
</template>  
